...
func RegisterExperiment(s *mcp.Server, cfg *config.Config) {
	mcp.AddTool(s, &mcp.Tool{Name: "synapse_experiment_list",
	...
	mcp.AddTool(s, &mcp.Tool{Name: "synapse_experiment_get",
	...
	mcp.AddTool(s, &mcp.Tool{Name: "synapse_experiment_create",
	...
	mcp.AddTool(s, &mcp.Tool{Name: "synapse_experiment_delete",
